...
The filter and the mocap are two independent systems that do not communicate with each other. To be able to compare them, their coordinate frames have to be aligned and their samples synchronized. When this is not done correctly, it leads to bias in error calculations.
    ...
    \todo[inline]{Coordinate frame pictures}
    \begin{itemize}
        \item Mocap
        \begin{itemize}
...
\section{Time synchronization}
    ...
    \missingfigure[figwidth=10cm]{Delayed position}
...
\begin{figure}
    \includegraphics[width=12cm]{img/Dataset06.png}
    \caption{Dataset \textit{1CW}}
    \label{fig:dataset06}
\end{figure}

\begin{figure}
    \includegraphics[width=12cm]{img/Dataset07.png}
    \caption{Dataset \textit{2CCW}}
    \label{fig:dataset07}
\end{figure}

\begin{figure}
    \includegraphics[width=12cm]{img/Dataset08.png}
...
\section{Results}
    ...
    \begin{figure}
        \includegraphics[width=12cm]{img/07_drift.png}
        \caption{Similar error, different estimation}
        \label{fig:07_drift}
    \end{figure}
    ...
    \begin{figure}
        \includegraphics[width=12cm]{img/thresholds.png}
    ...
    \begin{figure}
        \includegraphics[width=12cm]{img/low_thresholds.png}
    ...
    \begin{figure}
        \includegraphics[width=12cm]{img/noise.png}
...
\section{Future work}
Since even a low number of markers is enough for quality estimates, future work will concentrate on analyzing datasets with sparsely placed markers. For this purpose, the RCARS visualization package is helpful, because it provides live pose estimation in a 3D workspace and an image preview that contains both the marker detections and the corresponding estimations. This tool can also be used for finding the appropriate EKF parameters for the device to minimize the bias caused by improper EKF configuration. 

Furthermore, other devices can be used for testing, since the system is also affected by the field of view, the autofocusing system of the camera, and the camera and IMU synchronization.
